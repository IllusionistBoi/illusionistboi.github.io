...
- **2026-07-04** Redesign session (Codex Fable 5): audit of old site, new design direction,
  full rebuild of index.html/styles.css/main.js/demos.js, vendored GSAP, self-hosted fonts,
  AGENTS.md created. Mid-session the owner corrected the positioning (full-stack dev, not
